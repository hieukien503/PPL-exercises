...
class MachineCode(ABC):
    ...
    @abstractmethod
    def emitCASTORE(self):
        pass

    @abstractmethod
    def emitDASTORE(self):
        pass
...
class JasminCode(MachineCode):
    ...
    def emitLDC2_W(self, in_):
        # in_: String
        return JasminCode.INDENT + "ldc2_w " + in_ + JasminCode.END
    ...
    def emitDLOAD(self, in_):
        # in_: Int
        if in_ >= 0 and in_ <= 3:
            return JasminCode.INDENT + "dload_" + str(in_) + JasminCode.END
        else:
            return JasminCode.INDENT + "dload " + str(in_) + JasminCode.END
    ...
    def emitDSTORE(self, in_):
        # in_: Int
        if in_ >= 0 and in_ <= 3:
            return JasminCode.INDENT + "dstore_" + str(in_) + JasminCode.END
        else:
            return JasminCode.INDENT + "dstore " + str(in_) + JasminCode.END
    ...
    def emitDASTORE(self):
        return JasminCode.INDENT + "dastore" + JasminCode.END
    ...
    def emitDALOAD(self):
        return JasminCode.INDENT + "daload" + JasminCode.END
    ...
    def emitDADD(self):
        return JasminCode.INDENT + "dadd" + JasminCode.END
    ...
    def emitDSUB(self):
        return JasminCode.INDENT + "dsub" + JasminCode.END
    ...
    def emitDMUL(self):
        return JasminCode.INDENT + "dmul" + JasminCode.END
    ...
    def emitDDIV(self):
        return JasminCode.INDENT + "ddiv" + JasminCode.END
    ...
    def emitDNEG(self):
        return JasminCode.INDENT + "dneg" + JasminCode.END
    ...
    def emitDCMPL(self):
        return JasminCode.INDENT + "dcmpl" + JasminCode.END
    ...
    def emitDRETURN(self):
        return JasminCode.INDENT + "dreturn" + JasminCode.END
