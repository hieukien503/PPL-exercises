...
for path in ['./test/', './main/MT232/parser/', './main/MT232/utils/', './main/MT232/astgen/', './main/MT232/checker/', './main/MT232/codegen/']:
    sys.path.append(path)
ANTLR_JAR = os.environ.get('ANTLR_JAR')
TARGET_DIR = '../target'
GENERATE_DIR = 'main/MT232/parser'
...
def main(argv):
    if len(argv) < 1:
        ...
        subprocess.run(["java", "-jar", ANTLR_JAR, "-o", "../target",
                       "-no-listener", "-visitor", "main/MT232/parser/MT232.g4"])
    elif argv[0] == 'clean':
...
def printUsage():
    print("If you use python3, run one of the following command:")
    ...
    print("If not, run one of the following command:")
