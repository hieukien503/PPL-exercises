...
if not './main/MT232/parser/' in sys.path:
    sys.path.append('./main/MT232/parser/')
if os.path.isdir('../target/main/MT232/parser') and not '../target/main/MT232/parser/' in sys.path:
    sys.path.append('../target/main/MT232/parser/')
from MT232Lexer import MT232Lexer
...
class TestLexer:
    ...
    def check(soldir, inputfile, num):
        ...
        except (ErrorToken, UnclosedString, IllegalEscape, UnterminatedComment) as err:
...
class TestCodeGen():
    ...
    def check(soldir, asttree, num):
        ...
        try:
            ...
            subprocess.run("java -cp ./lib:. MT232",
